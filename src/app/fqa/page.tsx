...
const Page: React.FC = () => {
    ...
    return <div className="col-12 bg-fqa-pattern bg-cover bg-no-repeat min-h-screen overflow-hidden relative sm:min-h-fit ">
        ...
        <AnimatePresence>
            <div className='col-12 bg-seccondaryColor h-[460px] tablet:h-[272px] mac:h-[370px] relative top-0 flex flex-col justify-center items-center tablet:pt-[34px] pt-[100px] sm:h-[150px] '>
                <div className='text-whiteText relative text-center text-[48px] tablet:text-[30px] mac:text-[38px] mac:leading-[47px] tablet:leading-[36px] font-extrabold leading-[36px] flex flex-col items-center sm:text-[20px] sm:mb-[50px] '>
                    <IoMdChatbubbles className='text-[98px] tablet:text-[60px] mac:text-[77px] sm:hidden absolute top-[-50px] right-[-95px] tablet:top-[-7px] tablet:right-[-60px] mac:top-[-10px] mac:right-[-75px] ' /><br />
                    Frequently Asked Questions
                </div>

            </div>
            <div className='col-12 flex lg:flex-row min-h-[30vh] pt-[85px] tablet:pt-[36px] mac:pt-[41px] pr-[167px] mac:px-[105px] tablet:px-[50px] pb-[312px] tablet:pb-[100px] pl-[167px] items-start sm:py-[50px] sm:px-[14px] sm:flex-col ' key={Math.random()} >
                <div className='flex flex-col h-fit flex-1 pr-[100px] tablet:pr-[50px] mac:pr-[90px] '>
                    {
                ...
                <div className='flex flex-col h-fit flex-1 pl-[100px] tablet:pl-[50px] mac:pl-[90px] '>
                    {

    ...
    <div className='col-12 overflow-x-hidden relative p-0 max-w-[1920px] '>
      ...
      {showButton &&
        <button
          ...
          className="z-[500] shadow-[-5px_15px_22px_-5px_rgba(0,0,0,0.19)] fixed mini-tablet:left-[42%] mini-tablet:right-[42%] left-[45%] right-[45%] bottom-[68px] tablet:bottom-[54px] mini-tablet:bottom-[54px] mac:bottom-[90px] rounded-[32px] bg-background flex w-[175px] mac:w-[142px] mini-tablet:w-[136px] tablet:w-[136px] mini-tablet:h-[56px] tablet:h-[56px] tablet:rounded-[24px] h-[72px] justify-center items-center text-red text-[24px] mini-tablet:text-[18px] tablet:text-[18px] mac:text-[19px] font-bold leading-[40px] mini-tablet:leading-[36px] tablet:leading-[36px] sm:w-[130px] sm:text-[16px] sm:h-[44px] sm:font-extrabold sm:bottom-[40px] sm:left-[30%] sm:right-[30%] ">
          Start Now
        </button>
      }
    </div>

...
const AcademicTask: React.FC<_props> = ({ changeTabBarLoc, changeEndAnimation, endAnimation, topic, essay,
    ...
    return <Formik
        ...
        onSubmit={async (values, { resetForm }) => {
            ...
            <form
                ...
                {
                    loading ?
                        <Loading style={{ height: 615, minHeight: 0 }} />
                        :
                        <div
                            ref={targetRef}
                            style={{ height: 'fit-content', minHeight: 665 }}

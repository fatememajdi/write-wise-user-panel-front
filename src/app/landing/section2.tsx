...
export default function Section2() {
    ...
    return <section className="overflow-hidden pt-[58px] pb-[106px] w-full relative flex flex-col items-center bg-section2-gradiant sm:min-h-fit sm:pt-[20px] sm:pb-[100px]"
        id="how-it-works">
        <div className="flex flex-col items-start mb-[87px] sm:mb-[60px]">
            <h2 className="text-whiteText leading-[60px] text-center w-full sm:mx-[30px] sm:text-left sm:mr-auto sm:w-fit " >
                How it works
            </h2>

            <h6 className="text-whiteText mt-[50px] max-w-[58%] lg:mx-auto tracking-wider leading-[36px] sm:leading-[20px] sm:mt-0 sm:mx-[30px]">
...
const StepCard: React.FC<_props> = ({ Step }) => <div className='pt-[52px] pr-[23px] pb-[36px] pl-[80px] flex flex-col text-whiteText mb-[60px] min-h-[380px] justify-start w-full items-start sm:pt-[20px] sm:pr-[30px] sm:pb-[10px] sm:pl-[30px] sm:mb-[30px] sm:min-h-[246px] sm:justify-start'>
    <div className='font-normal text-[24px] text-justify leading-[36px] sm:text-[13px] sm:font-normal'>{Step.step}</div>
    <div className=' font-semibold text-[32px] leading-[36px] mt-[20px] text-left text-whiteText sm:text-[20px] sm:font-semibold sm:mt-[9px] sm:leading-[20px]'>{Step.title}</div>
    <div className='leading-[36px] sm:leading-[21px] text-[24px] sm:text-[13px] font-normal mt-[24px] sm:mt-[18px] text-left'>{Step.description}</div>
</div>
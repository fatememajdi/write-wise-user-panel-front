...
export default function PackageCard({ pack, loading, style }: _props) {
    return <div className=" w-[300px] h-[456px] bg-grayColor rounded-[12px] border-solid border-[1px] border-grayColor shadow-[0px 2px 2px 0px rgba(0, 82, 147, 0.18)] py-[27px] px-[20px] relative sm:w-[228px] sm:h-[346px] sm:py-[20px] sm:px-[15px] sm:mr-auto sm:ml-auto "
        style={{ ...style, backgroundColor: pack.isPopup && '#F3F3F3' }}>
        {
            pack.discountPercent > 0 ?
                ...
                : pack.isPopup &&
                <div style={{ paddingRight: 5 }} className="bg-background h-[78px] w-[78px] rounded-bl-full absolute z-2 right-[8px] top-[16px] text-red text-center text-[18.5px] font-bold leading-normal flex flex-col items-end justify-center pr-[15px] sm:h-[59px] sm:w-[59px] sm:right-[7px] sm:top-[12px] sm:text-[13.7px] sm:font-bold sm:pr-[14px] sm:leading-[18.6px] " >
                    <span>Limited</span>
                    <span>Offer</span>
                </div>
        }
        {
            loading ?
                ...
                <div style={pack.isPopup ? { backgroundColor: '#AB141D', paddingBottom: 27 } : {}}
                    ...
                    <div className="mt-[32px] text-whiteText text-[16px] font-normal leading-[23px] sm:text-[13.2px] sm:font-bold sm:leading-[18.7px] sm:mt-[16px] ">{pack.description}</div>
